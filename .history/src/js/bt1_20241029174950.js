...
const tinhThueThuNhap = ()=>{
    ...
    const tongThuNhap = paraseFloat(document.getElementById("tongThuNhap").value);
    const soNguoiPhuThuoc = paraseFloat(document.getElementById("soNguoiPhuThuoc").value);
    ...
    const formattedThuePhaiTra = new Intl.NumberFormat()
    document.getElementById('taxResult').innerHTML = `Họ tên: ${hoTen},Thuế thu nhập cá nhân phải trả: ${thuePhaiTra.toLocaleString()} triệu VND.`
}