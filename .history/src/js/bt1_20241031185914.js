...
const tinhHoaDon = () => {
    ...
    if(loaiKhachHang === "business"){// Nếu loại khách hàng là doanh nghiệp
        soKetNoi = parseInt(document.getElementById("soKetNoi").value) || 0; // Lấy giá trị từ ô nhập số kết nối
    }
    else{// Nếu loại khách hàng không phải là doanh nghiệp
        soKetNoi = 0;// Gán giá trị 0 cho soKetNoi
    }
