...
const kiemTra = ()=>{
    ...
    if(diemMon1 === 0 || diemMon2 === 0 || diemMon3 === 0){
        diemLiet = document.getElementById('result').innerHTML = "Rớt do có môn 0 điểm."
        return diemLiet;
    }
    ...
    if(tongDiem >= diemChuan){
        diemLiet = document.getElementById('result').innerHTML = `Đậu với tổng điểm:${tongDiem}`
        return diemLiet;
    }
    else{
        diemLiet = document.getElementById('result').innerHTML = `Rớt với tổng điểm: ${tongDiem}
        return diemLiet;
    }
}